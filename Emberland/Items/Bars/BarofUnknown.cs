...
namespace Emberland.Items.Bars
{
	public class BarofUnknown : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Bar of Unknown");
			Tooltip.SetDefault("Looks like something you'd find in a legend.");
		}
